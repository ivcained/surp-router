...
<div class="home-focus">
  <section class="home-hero">
    ...
    <p class="home-lede">Surp checks the live Surplus marketplace, routes each job to the lowest-cost suitable model, and serves identical questions from cache for $0.001. Connect once and pay in USDC on Base; your agent keeps shopping.</p>
